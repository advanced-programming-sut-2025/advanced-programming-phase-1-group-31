...
public class GreenHouseController extends GameController{
    @Override
    public void startPoint(TiledMap map) {
        String exitName = "outGreenHouse";
    ...
    public void handleFarmWarp(MapObject warpObject, Player owner) {
        ...
        Gdx.app.postRunnable(() -> {
            ...
            gameView.getGameController().setStartPoint(gameView.getMap() , "outGreenHouse");
