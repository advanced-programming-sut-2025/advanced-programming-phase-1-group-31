...
public enum ForagingCrops implements MaterialType {
    ...
    Hey("Hey (For Animals)", List.of(Seasons.Spring, Seasons.Summer, Seasons.Fall, Seasons.Winter), 10, 1, "project/Stardew_Valley_Images-main/Stardew_Valley_Images-main/Foraging/Holly.png"),
